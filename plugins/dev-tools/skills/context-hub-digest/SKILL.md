...
# 并剔除黑名单
BLACKLIST='^(cn-backend-workflow|docx-operator|fe-b-react-dev-kit|fe-b-vue2-dev-kit|fe-b-vue3-dev-kit|fe-c-dev-kit|fe-d2c|fe-plugin-report|fe-sdd|fe-workflow|internal-office|jar-inspect|oa-flow-submitter|project-plugin-check|sea-backend-workflow|sea-risk|test-kit|wecom-doc-general|wecom-meeting-report)$'
